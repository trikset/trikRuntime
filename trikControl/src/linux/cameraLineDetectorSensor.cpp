...
void CameraLineDetectorSensor::initDetector()
{
	qDebug() << "initDetector()";
	...
	mSocketNotifier.reset(new QSocketNotifier(mOutputFileDescriptor, QSocketNotifier::Read, this));
...
void CameraLineDetectorSensor::readFile()
{
	qDebug() << "new data";
